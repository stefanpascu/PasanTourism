...
<body>
    ...
    <form class="flex-container" method="post" action="rezervare.php">
        <div>
            <?php
                echo "<button id='logout-button' type='submit' class='link-button' name='1311'>RESTAURANT ROATA</button>";
                ?>
            <br><br>    
        </div>
        ...
        <div>
            <?php
                echo "<button id='logout-button' type='submit' class='link-button' name='1312'>CASA BOEMA</button>";
                ?>
            <br><br>  
        </div>
