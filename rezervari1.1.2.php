...
<body>
    ...
    <form class="flex-container" method="post" action="rezervare.php">        
        <div>
            <?php
                echo "<button id='logout-button' class='link-button' type='submit' class='link-button' name='1121'>RESTAURANT FOREST</button>";
            ?>
            <br><br>    
        </div>
        ...
        <div>
            <?php
                echo "<button id='logout-button' class='link-button' type='submit' class='link-button' name='1122'>RESTAURANT WOOD</button>";
            ?>
            <br><br>  
        </div>
